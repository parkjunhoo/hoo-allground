<template>
  <div class="editor" v-if="editor">
    ...
    <editor-content class="editor__content" :editor="editor" :v-model="currentContents" />
...
export default {
  ...
  mounted() {
    ...
    this.editor.commands.setContent(this.currentContents);
  },
  watch:{
    output(){
  ...
  methods: {
    clickSubmit(){
      axios.put('api/board/edit',{
        ...
        contents: this.output.localJSON,
      })
      .then((res)=>{
